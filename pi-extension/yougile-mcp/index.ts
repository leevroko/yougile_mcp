...
const DEFAULT_CONFIRM = [
  "create_task", "update_task", "create_board", "create_column", "delete_board", "audit_board",
...
export default function yougileMcpExtension(pi: ExtensionAPI) {
  ...
  const mutatingNames = new Set(
    ["create_task", "update_task", "create_board", "create_column", "delete_board", "audit_board", "bulk_move_tasks", "batch_update_stickers", "set_mode"]
  );
